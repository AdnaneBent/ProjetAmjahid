...
<!--== Clients Start ==-->
  <section class="pb-0">
    <div class="container">
      <div class="row">
          <h1 class="h1press fontsm30 textgold">Section Presse</h1>
          <div>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="pressmd wow fadeInUp row" data-wow-delay="0.1s">
                    ...
                    <div class="display-table mb-30 full-width ">
                        <div class="imgpress v-align-middle img-responsive">
                            <img src="{{Storage::disk('imgArticle')->url($article->image)}}" alt="{{$article->name}}" alt="">
                        </div>
                    </div>
                    <div class="presstxt" style="margin-right: 100px;text-align: justify;">
