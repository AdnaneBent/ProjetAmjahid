    ...
    <form role="form">
      <div class="box-body">
        <div class="form-group">
          ...
          @endif
          <input type="text" name="name" class="form-control" value="{{old('name', $galeries->name)}}" placeholder="Nom" >
        </div>
        {{-- image --}}
        <h5>Image</h5>
        <img src="" alt="">
      ...
      <div class="card-body">
        <a href="{{route('galeries.index')}}" class="btn card-link" style="background-color:#be8c3c;color:white;">Retour</a>
      </div>
      <!-- /.box-body -->
    </form>
  </div>
