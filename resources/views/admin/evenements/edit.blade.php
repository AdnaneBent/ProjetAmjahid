    ...
    <form role="form">
      <div class="box-body">
        <div class="form-group">
          ...
          @endif
          <input type="text" name="name" class="form-control" value="{{old('name', $evenement->name)}}" placeholder="Nom" >
        </div>
        {{-- image --}}
        <div class="form-group">
          {{-- name --}}
          ...
          @endif
          <input type="text" name="date" class="form-control" value="{{old('date', $evenement->date)}}" placeholder="Nom" >
        </div><br>
        <br>
